...
class Student:
 ...
 #first img
        img=Image.open(r"Image\sd_title.png")
 ...
 #bg img
        img3=Image.open(r"Image\white.jpg")
 ...
 # left label frame
        Left_frame=LabelFrame(main_frame,bg="white")
        Left_frame.place(x=10,y=10,width=730,height=580)
       

 # current course
        current_course_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Current Course information",font=("times new roman",12,"bold"))
        current_course_frame.place(x=5,y=10,width=720,height=115)
        ...
        year_combo["values"]=("Select Year","2020-21","2021-22","2022-23","2023-25")
        ...
        search_frame.place(x=5,y=5,width=690,height=70)
        ...
        table_frame.place(x=5,y=110,width=690,height=550)
...
#=================fetch data======
    ...
    def get_curser(self,event=""):
         cursor_focur=self.student_table.focus()
         content=self.student_table.item(cursor_focur)
         data=content["values"] 
    ...
    def update_data(self):
         if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            messagebox.showerror("Error","All field are requied",parent=self.root)
              ...
              try:
               Update=messagebox.askyesno("Update","Do ypu want to update this student details",parent=self.root)
               if Update>0:
                   conn=mysql.connector.connect(host="localhost",username="root",password="kiit",database="face_recognizer",auth_plugin='mysql_native_password')
                   my_cursor=conn.cursor()
    ...
    def delete_data(self):
        if self.va_std_id.get()=="":
             ...
             try:
                ...
                if delete>0:
                 conn=mysql.connector.connect(host="localhost",username="root",password="kiit",database="face_recognizer")
                 my_cursor=conn.cursor()
